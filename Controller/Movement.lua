...
local _, db = ...;
local Movement = db:Register('Movement', CPAPI.CreateEventHandler({'Frame', '$parentMovementHandler', CPLight, 'SecureHandlerAttributeTemplate'}, {
...
function Movement:UpdateConditionals()
    ...
    -- Safety check for RegisterAttributeDriver
